...
from model import RNN_ENCODER, CNN_ENCODER, CaptionTransformer, MiniGPTCaption
...
def build_models():
    # build model ############################################################
    # text_encoder = CaptionTransformer(dataset.n_words, 18, cfg.TEXT.EMBEDDING_DIM)
    text_encoder = MiniGPTCaption(dataset.n_words, 18, cfg.TEXT.EMBEDDING_DIM)
